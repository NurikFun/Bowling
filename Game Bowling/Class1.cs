...
namespace Bowling_Game
{
    ...
    public class BowlingGameTest
    {
        ...
        public void Roll(int kedly)
        {
            frames[counter++] = kedly;
        }
        ...
        {
            return frames[index] + frames[index + 1] + frames[index + 2];
        }
        ...
        private int Spares(int index)
        {
            return frames[index] + frames[index + 1] + frames[index + 2];
              
        }
        private int  Usual(int index)
        {
